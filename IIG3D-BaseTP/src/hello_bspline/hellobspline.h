#ifndef SIMPLEBSPLINE_H
#define SIMPLEBSPLINE_H
...
class SimpleBSpline : public OpenGLDemo {
public:
    explicit SimpleBSpline(int width, int height);
    ~SimpleBSpline() override;
