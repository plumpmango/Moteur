...
public:
    ...
    QAction *actionHello_subdivision;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionHello_subdivision = new QAction(MainWindow);
        actionHello_subdivision->setObjectName(QStringLiteral("actionHello_subdivision"));
        ...
        menu_Demo->addAction(actionHello_subdivision);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionHello_envmap->setText(QApplication::translate("MainWindow", "Hello cubemap ...", 0));
        actionHello_subdivision->setText(QApplication::translate("MainWindow", "Hello subdivision ...", 0));
